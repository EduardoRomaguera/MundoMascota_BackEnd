...
const schema_usuario = mongoose.Schema({
    ...
    enlaceFacebook : { type: String, required: true, unique: false },
    enlaceInstagram : { type: String, required: true, unique: false },
    enlaceTiktok : { type: String, required: true, unique: false },
